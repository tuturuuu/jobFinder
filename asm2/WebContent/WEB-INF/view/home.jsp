				...
				<c:forEach var="category" items="${categories}"
					...
					<div class="col-md-3 ">
						<ul class="category text-center">
							<li><a style="text-decoration: none !important;"<%-- th:href="${'/recruitment/category/'}+${categorie.id} --%>">
									<p>${category}</p> <span class="number">${recruitTimes.get(loopCounter.count -1)}</span>
						...
						<div class="sidebar-box">
							<div>
								<a th:href="${'/user/detail-company/'}+${companies[0]}"
									...
									class="img-fluid" alt="Colorlib Free Template"> --%> <img
									height="130" width="130" style="border-radius: 50px"
									class="img-fluid" src="data:image/png;base64,${company.logo}"
									alt="Image">
								...
								<div class="text p-3">
									<h3>
										<a th:href="${'/user/detail-company/'}+${companies[0]}"
											th:text="${companies[1]}"> ${company.companyName } </a>
									</h3>
									<p>
										<span class="number" style="color: black"
											th:text="${companies[3]}"></span>
										${recruitments.get(loopCounter.count-1).quantity} <span>Vị
											trí ứng tuyển</span>
									</p>
								</div>
							</div>
