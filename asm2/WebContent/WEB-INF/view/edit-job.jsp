  ...
  <script>
	...
	<c:if test="${sessionScope.role eq  1}">
		<section class="site-section" >
			<div class="container">
				<form:form action="/asm2/recruitment/edit" method="post" modelAttribute="recruitment">
					 <form:input
						type="hidden" class="form-control" id="job-location"
						path="createdAt"></form:input>
						...
						<div class="col-lg-12">
							<div class="p-4 p-md-5 border rounded" method="post">
								<h3 class="text-black mb-5 border-bottom pb-2">Chi tiết bài
									tuyển dụng</h3>
								<form:input type="hidden" path="recruitId"></form:input>
								<div class="form-group">
									<label for="email">Tiêu đề</label> 
									<form:input type="text"
										class="form-control" id="email" path="title" 
										></form:input>
								</div>
								<div class="form-group">
									<label for="job-location">Mô tả công việc</label>
									<form:textarea path="description" class="form-control" id="editorN"
									></form:textarea>
								</div>
								<div class="form-group">
									<label for="job-title">Kinh nghiệm</label> <form:input type="text"
										class="form-control" id="job-title" path="experience"
										></form:input>
								</div>
								<div class="form-group">
									<label for="job-title">Số người cần tuyển</label> <form:input
										type="number" class="form-control" id="job-title"
										path="quantity"></form:input>
								</div>
								<div class="form-group">
									<label for="job-location">Địa chỉ</label> <form:input type="text"
										class="form-control" id="job-location" path="address"
										></form:input>
								</div>
								<div class="form-group">
									<label for="job-location">Hạn ứng tuyển</label> <form:input
										type="date" class="form-control" id="job-location"
										path="deadline"></form:input>
								</div>
								<div class="form-group">
									<label for="job-location">Lương</label> <form:input type="text"
										class="form-control" id="job-location" path="salary"
										></form:input>
								</div>
